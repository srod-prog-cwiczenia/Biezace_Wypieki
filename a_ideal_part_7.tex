...
Definiujemy zbiór
\[ A_0 = \lbrace \frac{a_n + b_n}{2} \colon n = 1,2,\ldots\rbrace \cup \lbrace p^* \rbrace.
\]


Uwaga: Metoda konstrukcji zbioru $A$ jest technicznie kopią metody
użytej w pracy Głąb-Frankowska.

\flushleft{\it Fakt:} $A \in \aideal \setminus \aidealprime$.
\flushleft{\sc DOWÓD:} \todo{Spisać zwięzły dowod tegoż} 

Konstruujemy teraz zbiór $A_1$.
Wykorzystywać będziemy zbiór doskonały $P$
użyty uprzednio w konstrukcji zbioru $A_0$.
...
\[ A_1 = \lbrace l_n[A_0] \colon n = 1,2,\ldots\rbrace \cup \lbrace p^* \rbrace.
\]
...
\flushleft{\it Fakt 2:} $A$ nie jest sumą dwóch zbiorów z rodziny $\aidealprime$.

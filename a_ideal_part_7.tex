...
$m = 1,2,\ldots$ mielibyśmy $(a_m, b_m) \cap W \not= \emptyset$
to wtedy $(a_m, b_m) \cap W \in \tau_d \setminus \lbrace \emptyset \rbrace$,
więc skoro $l_m[A_n] \in \aideal$ (zarówno odwzorowanie liniowe $l_m$
jak i $l_m^{-1}$ są homeomorfizmami które zachowują punkty gęstości),
zatem istnieje zbiór otwarty $U$ taki, że $W \cap (a_m, b_m) \cap U \not=\emptyset$
i $l_m[A_n] \cap W \cap (a_m, b_m) \cap U = \emptyset$. To oznacza że
zbiór $U_1 = U \cap (a_m, b_m)$ jest taki, że $U_1 \cap W \not=\emptyset$
oraz $U_1 \cap A_{n+1} \cap W = \emptyset$.

Załóżmy zatem że $W \subseteq (0,1) \setminus \bigcup_{n=1}^\infty (a_n, b_n) \subseteq P$.
Wówczas $(0,1) \setminus \lbrace p^* \rbrace \cap W \not= \emptyset$
natomiast  $(0,1) \setminus \lbrace p^* \rbrace \cap W \cap A_{n+1} = \emptyset$.
W obu tych przypadkach znaleźliśmy zbiór otwarty $U_1$ taki że
$U_1 \cap W \not=\emptyset$ i $U_1 \cap W \cap A_{n+1} = \emptyset$
co dowodzi że $A_{n+1} \in \aideal$.
...
$m = 1,2,\ldots$ mielibyśmy $(a_m, b_m) \cap W \not= \emptyset$
to wtedy $(a_m, b_m) \cap W \in \tau_d \setminus \lbrace \emptyset \rbrace$,
więc skoro $l_m[A_m] \in \aideal$ (zarówno odwzorowanie liniowe $l_m$
jak i $l_m^{-1}$ są homeomorfizmami które zachowują punkty gęstości),
zatem istnieje zbiór otwarty $U$ taki, że $W \cap (a_m, b_m) \cap U \not=\emptyset$
i $l_m[A_m] \cap W \cap (a_m, b_m) \cap U = \emptyset$. To oznacza że
zbiór $U_1 = U \cap (a_m, b_m)$ jest taki, że $U_1 \cap W \not=\emptyset$
oraz $U_1 \cap A^* \cap W = \emptyset$.

Załóżmy zatem że $W \subseteq (0,1) \setminus \bigcup_{n=1}^\infty (a_n, b_n) \subseteq P$.
Wówczas $W \cap A^* \not= \emptyset$ i jako $U_1$ można wziąć
na przykład $(0,1)$.
W obu tych przypadkach znaleźliśmy zbiór otwarty $U_1$ taki że
$U_1 \cap W \not=\emptyset$ i $U_1 \cap W \cap A^* = \emptyset$
co dowodzi że $A^* \in \aideal$.

\missingfigure{
Zebrać parę identycznych dowodów we wspólnym lemacie:
mniej więcej takim:
Załóżmy że dla każdego $m = 1,2,\ldots$ mamy ustalony zbiór
$B_m \subseteq (a_m, b_m)$ taki że $B_m \in \aideal$.
Wówczas zbiór $\bigcup_{m=1}^{\infty} B_m \in \aideal$.
}

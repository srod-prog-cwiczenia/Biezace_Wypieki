...
the condition (a) is an ideal of sets, which is G_{\delta\sigma}-generated, but not F_{\sigma}-generated 
...
$\exists_{V\in\tau\setminus\lbrace\emptyset\rbrace}  \int (A \bigtriangleup V) = \emptyset$.
is the same collection of sets $A$ such that $\int\cl(A) \not\emptyset$. Indeed, (...)%%%TODO: completa este! 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         %
%                      Main part                                          %
%                                                                         %

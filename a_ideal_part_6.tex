...
\item
  $\forall_{E \in cF_1} \forall_{W \in \cF_2} E \cap W \not= \emptyset \implies E \cap W \in \cF2$  
\end{enumerate}	

Analogicznie do przestrzeni bitopologicznych, strukturê
$\langle \cF_1, \cF_2 \rangle$ nazywamy {\it bisystemem MB}.



\begin{theorem}
Niech $\langle \cF_1, \cF_2 \rangle$ bêdzie bisystemem MB.
Wówczas rodzina 
$\aideal(\cF_1, \cF_2) = (...)$ 
\end{theorem}																								  

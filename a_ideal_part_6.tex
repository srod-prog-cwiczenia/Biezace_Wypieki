...
%\begin{proof}
%Wiemy ¿e $l_m[A_1] \in \aideal$, bo zarówno odwzorowanie liniowe $l_m$
%jak i $l_m^{-1}$ s± homeomorfizmami które zachowuj± punkty gêsto¶ci.
%Po³ó¿my zatem w Lemacie \ref{lemat-o-sumie} 
%$B_m = l_m[A_1]$ i z faktu i¿ $\aideal$ jest idea³em
%zawieraj±cym singletony dostajemy natychmiast wniosek
%¿e $A_2 \in \aideal$.
%
%\flushleft{\it Fakt 2:} $A_2$ nie jest sum± dwóch zbiorów z rodziny $\aidealprime$.
%Przypu¶æmy ¿e $A_2 \subseteq (E_1 \setminus \Phi(E_1)) \cup (E_2 \setminus \Phi(E_2))$
%dla pewnych dwóch zbiorów domkniêtych $E_1, E_2$.  Przypu¶æmy ¿e dla pewnego 
%$m = 1,2,\ldots$ mieliby¶my ¿e $l_m[A_1] \cap E_2 = \emptyset$.
%Wówczas $l_m[A_1] \subseteq E_1 \setminus \Phi(E_1)$, czyli 
%$A_1 \subseteq l_m^{-1}[E_1] \setminus \Phi(l_m^{-1}[E_1])$, gdy¿
%odwzorowanie liniowe $l_m$ zachowuje punkty gêsto¶ci (i tak samo odwzorowanie odwrotne). Poniewa¿ 
%przeprowadza ono te¿ zbiory domkniête na zbiory domkniête (i tak samo odwzorowanie odwrotne)
%wiêc daje to sprzeczo¶æ z tym ¿e $A_1 \not\in \aidealprime$.
%Zatem $l_m[A_1] \cap E_2 \not= \emptyset$.
%Identyczne rozumowanie (ze wzglêdu na symetriê za³o¿eñ o $E_1$ i $E_2$)
%pokazuje ¿e tak¿e i $l_m[A_1] \cap E_1 \not= \emptyset$.
%Poniewa¿ $l_m[A_1] \subseteq (a_m, b_m)$
%wiêc $P \subseteq E_1$ i $P \subseteq E_2$. 
%Mamy zatem $p^* \in \Phi(P) \subseteq \Phi(E_1)$
%i $p^* \in \Phi(P) \subseteq \Phi(E_2)$
%czyli $p^* \not\in (E_1 \setminus \Phi(E_1)) \cup (E_2 \setminus \Phi(E_2))$
%co jest niemo¿liwe bo $p^* \in A_2$.
%\end{proof}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%TODO: które zachowuj± punkty gêsto¶ci, ale nie wiem jak to przetlumaczyc

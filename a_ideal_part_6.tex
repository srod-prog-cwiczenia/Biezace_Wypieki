...
It turned out that $\aideal(\tau_e, \tau_d)$ is the ideal $(a)$.
...
\begin{proof}
This follows from the fact that $\cF_{\meager} \subseteq \Baire\setminus\meager$ (see \cite{PWBW}, Remark 2) and

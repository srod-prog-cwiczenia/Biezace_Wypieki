...
Suppose that $\mu{x}(\mu)$ is such that
$|\hat{x}(\mu) - x(\mu)| < \frac{\eta_0}{2}$.
Then we have:
$(\hat{x}(\mu) \cos \theta^*_k - y(\mu) | \sin \theta^*_k | - \frac{\eta_0}{2};
(\hat{x}(\mu) \cos \theta^*_k - y(\mu) | \sin \theta^*_k | + \frac{\eta_0}{2})\subseteq$
$
(\hat{x}(\mu) \cos \theta^*_k - y(\mu) | \sin \theta^*_k | - \eta_0;
(\hat{x}(\mu) \cos \theta^*_k - y(\mu) | \sin \theta^*_k | + \eta_0).
$
\end{proof}
